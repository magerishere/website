				...
				<div class="d-flex">
					...
					<div class="flex-shrink-0 mr-7">
						<div class="symbol symbol-50 symbol-lg-120">
							<a href="/admin/users/{{$comment->id}}/edit"><img width="50" src="{{$comment->photo}}" alt="Pic" ></a>
						</div>
					</div>
					<!--end::Pic-->
					<!--begin: Info-->
					<div class="flex-grow-1">
						...
						<div class="d-flex align-items-center justify-content-between flex-wrap mt-2">
							...
							<div class="mr-3">
								<!--begin::Name-->
								<a href="/admin/users/{{$comment->id}}/edit" class="d-flex align-items-center text-dark text-hover-primary font-size-h5 font-weight-bold mr-3">{{$comment->author}}
							...
							<div class="my-lg-0 my-1">
								<div class="row">
								{!! Form::open(['method'=>'PATCH','action'=>['App\Http\Controllers\PostCommentsController@update','static']]) !!}
								@csrf
								{!! Form::hidden('id',$comment->id) !!}
								@if ($comment->is_active == 1)
									{!! Form::hidden('is_active',0) !!}
									{!! Form::submit('Block',['class'=>'btn btn-warning']) !!}
								@else
								...
								{!! Form::open(['method'=>'DELETE','action'=>['App\Http\Controllers\AdminUsersController@update',$comment->id*95632/47852]]) !!}
								@csrf
						...
						<div class="d-flex align-items-center flex-wrap justify-content-between">
							<!--begin::Description-->
							<div class="flex-grow-1 font-weight-bold text-dark-50 py-2 py-lg-2 mr-5">{{ Str::limit($comment->body,50) }}</div>
							<!--end::Description-->
							<!--begin::Progress-->
