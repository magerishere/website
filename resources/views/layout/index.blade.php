							...
							<div class="container">
								...
								<div class="d-none d-lg-flex align-items-center mr-3">
									...
									<a href="/dashboard" class="mr-20">
										{{-- <img alt="Logo" src="/images/logo.png" class="max-h-40px" /> --}}
									</a>
									<!--end::Logo-->
								</div>
								<!--end::Left-->
								...
								<div class="topbar topbar-top" id="kt_header_topbar">
									...
									<div class="topbar-item mr-3 w-100 w-lg-auto justify-content-start">
										<div class="quick-search quick-search-inline w-auto w-lg-200px" id="kt_quick_search_inline">
											...
											<form method="get" class="quick-search-form">
												<div class="input-group rounded bg-secondary">
											...
											<!--end::Form-->
											<!--begin::Search Toggle-->
											<div id="kt_quick_search_toggle" data-toggle="dropdown" data-offset="10px, 10px"></div>
											<!--end::Search Toggle-->
											<!--begin::Dropdown-->
									...
									<!--begin::Quick panel-->
									<div class="topbar-item mr-3">
										<div class="btn btn-icon btn-secondary" id="kt_quick_panel_toggle">
											<span class="svg-icon svg-icon-lg">
									...
									<!--begin::Chat-->
									<div class="topbar-item mr-3">
										<div class="btn btn-icon btn-secondary" data-toggle="modal" data-target="#kt_chat_modal">
											<span class="svg-icon svg-icon-lg">
						...
						<div class="header-bottom" id="kt_header_bottom">
							...
							<div class="container d-flex flex-column">
								...
								<ul class="header-tabs nav flex-column-auto" role="tablist">
									<!--begin::Item-->
									<li class="nav-item">
										<a  id="users" href="#menu2" class="nav-link" data-toggle="tab" role="tab">
									...
									<li class="nav-item">
										<a id="user" href="#menu4" class="nav-link" data-toggle="tab" role="tab">
											<span class="nav-title text-uppercase">Create User</span>
										</a>
									</li>
									<!--end::Item-->
									<!--begin::Item-->
									<li class="nav-item">
										<a data-toggle="tab" id="posts" href="#menu1" class="nav-link active"  role="tab">
											<span  class="nav-title text-uppercase">Posts</span>
										</a>
									</li>

									<li class="nav-item">
										<a id="post" href="#menu3" class="nav-link" role="tab" data-toggle="tab">
											<span  class="nav-title text-uppercase">Create Post</span>
										</a>
									</li>
									<!--end::Item-->
									<!--begin::Item-->
									<li class="nav-item">
										<a id="comments"  href="#menu5" class="nav-link" data-toggle="tab"  role="tab">
											<span class="nav-title text-uppercase">Comments</span>
										</a>
									</li>
									<li class="nav-item">
										<a id="categories"  href="#menu6" class="nav-link" data-toggle="tab"  role="tab">
											<span class="nav-title text-uppercase">Categories</span>
										</a>
									</li>
									<!--end::Item-->
								</ul>
									...
									<div class="tab-content">
													...
													<li class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="click" aria-haspopup="true">
														...
														<div class="menu-submenu menu-submenu-classic menu-submenu-left">
															<ul class="menu-subnav">
																...
																<li class="menu-item" aria-haspopup="true">
																	<a target="_blank" href="https://preview.keenthemes.com/metronic/demo11/builder.html" class="menu-link">
																		<span class="svg-icon menu-icon">
										...
										<div class="tab-pane justify-content-between px-4 px-lg-0" id="kt_header_tab_2">
											<div class="d-flex flex-column flex-lg-row align-items-start align-items-lg-center">
												<!--begin::Actions-->
												<a href="#" class="btn btn-light font-weight-bold mr-3 my-2 my-lg-0">Latest Orders</a>
												<a href="#" class="btn btn-light font-weight-bold my-2 my-lg-0">Customer Service</a>
												<!--end::Actions-->
											</div>
											<div class="d-flex align-items-center">
												<!--begin::Actions-->
...
<!-- end::User Panel-->
		...
		<ul class="sticky-toolbar nav flex-column pl-2 pr-2 pt-3 pb-3 mt-4">
			...
			<li class="nav-item mb-2" data-toggle="tooltip" title="Layout Builder" data-placement="left">
				<a class="btn btn-sm btn-icon btn-bg-light btn-icon-primary btn-hover-primary" href="https://preview.keenthemes.com/metronic/demo11/builder.html" target="_blank">
